...
char correctInput(int min, int max, char posX, char posY, boolean back)
{
	int input;
	gotoxy(0,0);
	gotoxy(posX,posY + 1);
...
char HeadAndFooter(char Number)
{
	//gotoxy(0,0);
	//setColor(7,1);
